              ...
              >
                ...
                <span
                  style={{
                    ...
                    fontSize: 11,
                    fontWeight: 600,
                    color: b.remaining < 500 ? "#dc2626" : "#16a34a",
                  }}
                >
          ...
          {contracts.map((c, i) => (
            <div
              ...
              style={{
                ...
                alignItems: "center",
                borderBottom:
                  i < contracts.length - 1 ? "1px solid #f1f5f9" : "none",
                fontSize: 12,
                cursor: "pointer",
              }}
              onMouseEnter={(e) =>
          ...
          {orders.map((o, i) => (
            <div
              ...
              style={{
                ...
                alignItems: "center",
                borderBottom:
                  i < orders.length - 1 ? "1px solid #f1f5f9" : "none",
                fontSize: 12,
              }}
            >
              <span style={{ fontWeight: 500, color: "#0f172a" }}>
  ...
  if (subPath === "/erp/labor") {
    return (
      <div style={{ padding: 24, maxWidth: 1400, margin: "0 auto" }}>
        ...
        >
          {[
            { l: "総労務者数", v: "1,248名", c: "#1a56db", bg: "#eff6ff" },
            { l: "本月労務費", v: "¥186M", c: "#f97316", bg: "#fff7ed" },
            { l: "平均残業", v: "18.5h", c: "#7c3aed", bg: "#f5f3ff" },
            { l: "有給取得率", v: "72%", c: "#16a34a", bg: "#f0fdf4" },
          ].map((s, i) => (
            <div
              key={i}
              style={{
            ...
            >
              ...
              >
                <Icon name="users" size={16} style={{ color: s.c }} />
              </div>
              <div>
        ...
        <div style={cs}>
          ...
          {[
            ...
            >
              <span style={{ width: 120, fontWeight: 500, color: "#0f172a" }}>
                {d.dept}
              </span>
              <span style={{ width: 60, color: "#374151" }}>{d.staff}名</span>
              <span style={{ width: 80, color: "#64748b", fontSize: 11 }}>
                現場{d.field}
              </span>
              <span style={{ width: 80, color: "#64748b", fontSize: 11 }}>
                内勤{d.office}
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
                ...
                >
                  <div
                    style={{
                      height: "100%",
                      width: `${(p.collected / p.contract) * 100}%`,
                      background: "#1a56db",
                      borderRadius: 3,
                    }}
                  ></div>
