              ...
              {["日", "週", "月"].map((u) => (
                <button
                  ...
                  style={{
                    ...
                    borderRadius: 4,
                    border: "none",
                    background: u === "月" ? "#1a56db" : "#f1f5f9",
                    color: u === "月" ? "#fff" : "#64748b",
                    fontSize: 11,
                    cursor: "pointer",
                    fontFamily: "inherit",
                  }}
          ...
          {measurements.map((m, i) => (
            <div
              ...
              style={{
                ...
                alignItems: "center",
                borderBottom:
                  i < measurements.length - 1 ? "1px solid #f1f5f9" : "none",
                fontSize: 12,
              }}
            >
          ...
          {patrols.map((p, i) => (
            <div
              ...
              style={{
                ...
                alignItems: "center",
                borderBottom:
                  i < patrols.length - 1 ? "1px solid #f1f5f9" : "none",
                fontSize: 12,
              }}
            >
              ...
              <span
                style={{
                  fontWeight: 600,
                  color: p.findings > 0 ? "#f97316" : "#16a34a",
                }}
              >
                {p.findings}件
              </span>
              <span
                style={{
                  fontWeight: 600,
                  color: p.critical > 0 ? "#dc2626" : "#16a34a",
                }}
              >
                {p.critical}件
              </span>
          ...
          {equipment.map((e, i) => (
            <div
              ...
              style={{
                ...
                alignItems: "center",
                borderBottom:
                  i < equipment.length - 1 ? "1px solid #f1f5f9" : "none",
                fontSize: 12,
              }}
            >
              <span style={{ fontWeight: 500, color: "#0f172a" }}>
              ...
              >
                <span
                  style={{
                    ...
                    height: 6,
                    borderRadius: "50%",
                    background: stColor[e.status] || "#64748b",
                  }}
                ></span>
                {e.status}
              </span>
          ...
          {workers.map((w, i) => (
            <div
              ...
              style={{
                ...
                alignItems: "center",
                borderBottom:
                  i < workers.length - 1 ? "1px solid #f1f5f9" : "none",
                fontSize: 12,
              }}
            >
              <span style={{ fontWeight: 500, color: "#0f172a" }}>
              ...
              <span
                style={{
                  fontSize: 10,
                  fontWeight: 600,
                  color: w.status === "作業中" ? "#16a34a" : "#f97316",
                }}
              >
                {w.status}
              </span>
              ...
              >
                ...
                <span
                  style={{
                    ...
                    height: 8,
                    borderRadius: "50%",
                    background: c.status === "live" ? "#16a34a" : "#94a3b8",
                  }}
                ></span>
              </div>
            </div>
