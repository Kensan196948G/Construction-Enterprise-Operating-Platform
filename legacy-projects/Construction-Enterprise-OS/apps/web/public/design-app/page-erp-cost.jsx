...
function ERPCostView() {
  ...
  const BarCompare = ({ budget, actual, forecast }) => {
    ...
    return (
      ...
      >
        {[
          { label: "予算", value: budget, color: "#94a3b8" },
          { label: "実績", value: actual, color: "#1a56db" },
          {
            label: "予測",
            value: forecast,
            color: forecast > budget ? "#dc2626" : "#16a34a",
          },
        ].map((b, i) => (
          <div
            key={i}
          ...
          >
            <span style={{ fontSize: 9, color: "#94a3b8", width: 24 }}>
              {b.label}
            </span>
            <div
              style={{
      ...
      >
        {[
          ...
          >
            ...
            >
              <Icon name={k.i} size={16} style={{ color: k.c }} />
            </div>
            <div>
            ...
            return (
              <div
                ...
                style={{
                  ...
                  alignItems: "center",
                  borderBottom:
                    i < costData.length - 1 ? "1px solid #f1f5f9" : "none",
                }}
              >
                <span
