              ...
              {[
                ...
                <div
                  ...
                  style={{
                    ...
                    padding: "10px 12px",
                    borderRadius: 8,
                    background: s.alert ? "#fff7ed" : "#f8fafc",
                  }}
                >
                  <span
                    style={{
                  ...
                  <span
                    style={{
                      fontSize: 12,
                      color: s.alert ? "#f97316" : "#64748b",
                      fontWeight: s.alert ? 600 : 400,
                    }}
                  >
                    {s.wind}
                  </span>
          ...
          <div style={{ padding: 20 }}>
            ...
            >
              ...
              <line
                ...
                strokeDasharray="4,4"
              />
              <text x="605" y="38" fontSize="9" fill="#dc2626">
                基準値 2.0m
              </text>
            </svg>
            <div
              ...
              >
                ...
                <span
                  style={{
                    ...
                    padding: "2px 8px",
                    borderRadius: 10,
                    background: w.status === "正常" ? "#dcfce7" : "#fff7ed",
                    color: w.status === "正常" ? "#166534" : "#92400e",
                  }}
                >
                  {w.status}
                </span>
      ...
      <div style={{ padding: 24, maxWidth: 1400, margin: "0 auto" }}>
        ...
        <div style={cs}>
          <div
            style={{
              display: "grid",
              gridTemplateColumns: "80px 1fr 80px 70px 60px 50px 100px",
              gap: 12,
              padding: "10px 16px",
              borderBottom: "1px solid #e2e8f0",
              fontSize: 11,
          ...
          {gateways.map((g, i) => (
            <div
              ...
              style={{
                ...
                alignItems: "center",
                borderBottom:
                  i < gateways.length - 1 ? "1px solid #f1f5f9" : "none",
                fontSize: 12,
              }}
            >
              <span
              ...
              <span
                style={{
                  ...
                  height: 8,
                  borderRadius: "50%",
                  background: g.status === "online" ? "#16a34a" : "#f97316",
                }}
              ></span>
              <span
                style={{
                  fontSize: 11,
                  color: g.signal === "弱" ? "#f97316" : "#16a34a",
                }}
              >
                {g.signal}
              </span>
              ...
              >
                ...
                <span
                  style={{
                    ...
                    padding: "2px 8px",
                    borderRadius: 10,
                    background: e.status === "running" ? "#dcfce7" : "#f1f5f9",
                    color: e.status === "running" ? "#166534" : "#64748b",
                  }}
                >
    ...
    const alerts = [
      {
        time: "09:12",
        sensor: "風速計 #3",
        message: "風速8.5m/s — 10m/s超過でクレーン作業中止",
        severity: "warning",
        site: "品川タワー",
        ack: false,
      },
          ...
          {alerts.map((a, i) => (
            <div
              ...
              style={{
                ...
                alignItems: "center",
                gap: 12,
                background: a.ack ? "#fff" : sevBg[a.severity],
              }}
            >
              <Icon
                name="alert-triangle"
                size={16}
                style={{ color: sevColor[a.severity], flexShrink: 0 }}
              />
              <div style={{ flex: 1 }}>
                <div
                  style={{
