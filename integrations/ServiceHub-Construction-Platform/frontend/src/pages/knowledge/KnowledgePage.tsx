...
import { Badge, Button, Card, DataActions, ErrorBanner, ErrorText, Modal, FormField, Input, Select, Textarea, Skeleton } from "@/components/ui";
...
export default function KnowledgePage() {
  ...
  const exportData = {
    columns: ["タイトル", "カテゴリ", "タグ", "閲覧数", "評価", "公開"],
    rows: filtered.map((a: KnowledgeArticle): CellValue[] => [
      a.title,
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          <DataActions target="ナレッジ" exportData={exportData} />
