...
import { Card, Badge, DataActions } from "@/components/ui";
...
const QUOTES: Quote[] = [
  ...
  { id: "EST-2026-0037", project: "品川マンション防水改修工事",            client: "品川不動産管理",    amount:  3_600_000, status: "approved", submittedAt: "2026-04-08" },
  { id: "EST-2026-0036", project: "新宿ビル外壁補修工事",                  client: "新宿ビル管理組合",  amount:  6_100_000, status: "sent",     submittedAt: "2026-05-01" },
  { id: "EST-2026-0035", project: "埼玉物流センター増築",                  client: "関東物流株式会社",  amount: 25_000_000, status: "draft",    submittedAt: "2026-05-05" },
  { id: "EST-2026-0034", project: "池袋商業ビル耐震補強",                  client: "池袋開発株式会社",  amount: 31_500_000, status: "approved", submittedAt: "2026-03-28" },
  { id: "EST-2026-0033", project: "目黒マンション共用部改修",              client: "目黒管理組合",      amount:  2_800_000, status: "sent",     submittedAt: "2026-05-08" },
  { id: "EST-2026-0032", project: "千葉工場屋根改修工事",                  client: "千葉製造株式会社",  amount:  9_200_000, status: "rejected", submittedAt: "2026-03-20" },
];

const INVOICES: Invoice[] = [
  { id: "INV-2026-0112", project: "横浜マンション改修工事 3期",  amount:  8_400_000, dueDate: "2026-06-15", status: "unpaid" },
  { id: "INV-2026-0108", project: "渋谷オフィスビル 2期",        amount: 22_000_000, dueDate: "2026-05-20", status: "overdue",  daysOverdue: 4 },
  { id: "INV-2026-0107", project: "川崎倉庫増築 1期",            amount:  5_500_000, dueDate: "2026-05-10", status: "overdue",  daysOverdue: 12 },
  { id: "INV-2026-0104", project: "品川マンション防水改修",       amount:  3_600_000, dueDate: "2026-06-30", status: "unpaid" },
  { id: "INV-2026-0103", project: "大宮工場改修工事 1期",         amount:  8_200_000, dueDate: "2026-06-20", status: "unpaid" },
  { id: "INV-2026-0099", project: "渋谷オフィスビル 1期",        amount: 20_000_000, dueDate: "2026-04-30", status: "paid" },
  { id: "INV-2026-0094", project: "横浜マンション 2期",          amount:  7_600_000, dueDate: "2026-04-15", status: "paid" },
  { id: "INV-2026-0090", project: "池袋商業ビル耐震補強 1期",     amount: 15_000_000, dueDate: "2026-04-01", status: "paid" },
  { id: "INV-2026-0088", project: "新宿ビル外壁補修 1期",         amount:  3_050_000, dueDate: "2026-05-31", status: "unpaid" },
  { id: "INV-2026-0085", project: "千葉工場屋根改修 最終",        amount:  9_200_000, dueDate: "2026-03-31", status: "overdue",  daysOverdue: 20 },
];
...
const ESTIMATES_EXPORT_DATA = {
  columns: ["見積番号", "案件", "施主", "金額(万円)", "ステータス", "提出日"],
  rows: QUOTES.map((q): CellValue[] => [
    q.id, q.project, q.client,
    Math.round(q.amount / 10000),
    ...
    <div className="space-y-6">
      <div className="flex items-start justify-between gap-4 flex-wrap">
        ...
        <div className="flex gap-3">
          <DataActions target="見積・請求" exportData={ESTIMATES_EXPORT_DATA} />
