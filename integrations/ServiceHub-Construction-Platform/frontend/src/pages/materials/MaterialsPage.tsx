...
const MATERIALS: Material[] = [
  ...
  { sku: "MT-0105", name: "軽量鉄骨 C-100",           category: "鋼材・ボルト",   unit: "本", stock: 120, min: 100, ordered: 0,  status: "normal",    project: "品川" },
  { sku: "MT-0118", name: "断熱材 グラスウール",      category: "断熱・防音材",   unit: "m²", stock: 80,  min: 150, ordered: 100,status: "low",       project: "大宮" },
  { sku: "MT-0123", name: "石膏ボード 9.5mm",         category: "内装材",         unit: "枚", stock: 600, min: 400, ordered: 0,  status: "overstock", project: "渋谷" },
  { sku: "MT-0137", name: "防水シート ルーフィング",  category: "防水材",         unit: "m²", stock: 8,   min: 50,  ordered: 80, status: "critical",  project: "横浜" },
];
...
const ORDERS = [
  { id: "PO-2026-0112", material: "普通ポルトランドセメント",  qty: "30t",   eta: "2026-05-28", status: "配送中" },
  { id: "PO-2026-0113", material: "異形棒鋼 D13",              qty: "20t",   eta: "2026-06-02", status: "発注済" },
  { id: "PO-2026-0114", material: "ALC パネル",                qty: "40枚",  eta: "2026-06-10", status: "確認待" },
  { id: "PO-2026-0115", material: "断熱材 グラスウール",       qty: "100m²", eta: "2026-06-05", status: "発注済" },
  { id: "PO-2026-0116", material: "防水シート ルーフィング",   qty: "80m²",  eta: "2026-05-30", status: "確認待" },
];
...
export default function MaterialsPage() {
  ...
  const exportData = {
    columns: ["SKU", "品名", "分類", "在庫", "単位", "発注中", "最低在庫", "現場", "状態"],
    rows: filtered.map((m): CellValue[] => [
      m.sku, m.name, m.category, m.stock, m.unit,
      m.ordered, m.min, m.project, STATUS_CONFIG[m.status].label,
    ]),
  };
    ...
    <div className="space-y-6">
      <div className="flex items-start justify-between gap-4 flex-wrap">
        ...
        <div className="flex items-center gap-2">
          <DataActions target="資材・在庫" exportData={exportData} />
