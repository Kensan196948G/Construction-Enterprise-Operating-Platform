...
const MILESTONES = [
  ...
  { name: "地盤改良完了",        date: "2026-05-20", project: "川崎倉庫増築工事",         done: true },
  { name: "型枠撤去完了",        date: "2026-05-28", project: "横浜マンション改修工事",   done: true },
  { name: "内装下地完了",        date: "2026-06-25", project: "渋谷オフィスビル新築工事", done: false },
  { name: "設備機器搬入",        date: "2026-07-15", project: "横浜マンション改修工事",   done: false },
  { name: "完成引き渡し",        date: "2026-10-31", project: "渋谷オフィスビル新築工事", done: false },
];
...
const CRITICAL_PATHS = [
  ...
  { project: "品川マンション改修工事",   delay: 0,  reason: null },
  { project: "大宮工場改修工事",         delay: 2,  reason: "資材調達の遅れ（ALC パネル）" },
];
...
const GANTT_ITEMS: GanttItem[] = [
  ...
  { task: "地盤改良",   project: "川崎",   start: 0, span: 2, status: "done" },
  { task: "型枠設置",   project: "横浜",   start: 2, span: 3, status: "done" },
  { task: "防水工事",   project: "品川",   start: 3, span: 2, status: "on-track" },
  { task: "電気工事",   project: "大宮",   start: 4, span: 4, status: "delayed" },
  { task: "外構工事",   project: "渋谷",   start: 6, span: 2, status: "on-track" },
];
...
const MILESTONE_EXPORT_DATA = {
  columns: ["マイルストーン", "案件", "予定日", "状態"],
  rows: MILESTONES.map((m): CellValue[] => [m.name, m.project, m.date, m.done ? "完了" : "未完"]),
};
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-start justify-between gap-4 flex-wrap">
        ...
        <DataActions target="工程スケジュール" exportData={MILESTONE_EXPORT_DATA} />
      </div>
