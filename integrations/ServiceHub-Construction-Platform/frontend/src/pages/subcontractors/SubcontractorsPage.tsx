...
const COMPANIES: Company[] = [
  ...
  { id: "SC-007", name: "富士防水工業",     trade: "防水",     contact: "中村 七雄", workers: 8,  todayCount: 4,  ccus: true,  status: "active" },
  { id: "SC-008", name: "横浜ガラス工業",   trade: "ガラス",   contact: "小林 八男", workers: 5,  todayCount: 2,  ccus: false, status: "active" },
  { id: "SC-009", name: "三菱空調サービス", trade: "空調設備", contact: "加藤 九郎", workers: 11, todayCount: 0,  ccus: true,  status: "inactive" },
  { id: "SC-010", name: "大和タイル工業",   trade: "タイル",   contact: "吉田 十郎", workers: 6,  todayCount: 3,  ccus: true,  status: "active" },
];
...
const TODAY_ASSIGNMENTS = [
  ...
  { site: "品川マンション改修", company: "富士防水工業",    trade: "防水",    count: 4,  lead: "中村 七雄",  time: "08:00" },
  { site: "渋谷オフィスビル",   company: "横浜ガラス工業",  trade: "ガラス",  count: 2,  lead: "小林 八男",  time: "09:30" },
  { site: "大宮工場改修",       company: "大和タイル工業",  trade: "タイル",  count: 3,  lead: "吉田 十郎",  time: "08:00" },
];
...
export default function SubcontractorsPage() {
  ...
  const exportData = {
    columns: ["ID", "会社名", "職種", "登録職人数", "本日稼働", "担当者", "CCUS", "状態"],
    rows: filtered.map((c): CellValue[] => [
      c.id, c.name, c.trade, c.workers, c.todayCount,
      c.contact, c.ccus ? "連携済" : "未連携",
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-start justify-between gap-4 flex-wrap">
        ...
        <DataActions target="協力会社" exportData={exportData} />
      </div>
