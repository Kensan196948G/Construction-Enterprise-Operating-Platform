...
class RegistrationTokenRequest(BaseModel):
    ...
    """ # noqa: E501
    profile: StrictStr
    fingerprint: Annotated[str, Field(min_length=64, strict=True, max_length=64)] = Field(description="SHA-256 hex digest of machine-id:MAC")
    __properties: ClassVar[List[str]] = ["profile", "fingerprint"]
