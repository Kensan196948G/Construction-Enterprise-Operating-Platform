...
class IsoBuildSummary(BaseModel):
    ...
    running: Optional[StrictInt] = 0
    succeeded: Optional[StrictInt] = 0
    failed: Optional[StrictInt] = 0
    cancelled: Optional[StrictInt] = 0
    __properties: ClassVar[List[str]] = ["total", "running", "succeeded", "failed", "cancelled"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "cancelled": obj.get("cancelled") if obj.get("cancelled") is not None else 0
        })
        return _obj
