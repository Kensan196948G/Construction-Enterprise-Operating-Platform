...
const MENU_STRUCTURE = [
  {
    id: 'dashboard', icon: 'chart-bar', label: 'ダッシュボード',
    sections: [
      { id: 'dash-main', label: '統合ダッシュボード', defaultOpen: true,
        pages: [
          { id: 'dash-all',    label: '全社統合',       href: '/dashboard',      badge: null },
          { id: 'dash-field',  label: '現場ダッシュボード', href: '/dashboard/field', badge: null },
          { id: 'dash-exec',   label: '経営ダッシュボード', href: '/dashboard/exec',  badge: null },
          { id: 'dash-ai',     label: 'AI分析',          href: '/dashboard/ai',    badge: null },
          { id: 'dash-kpi',    label: 'KPI/アラート',     href: '/dashboard/kpi',   badge: '3' },
        ]
      },
    ]
  },
  {
    id: 'common', icon: 'building', label: '共通基盤',
    sections: [
      { id: 'auth', label: '認証管理', roles: ['admin'],
        pages: [
  ...
  {
    id: 'documents', icon: 'folder', label: '文書・図面管理',
    sections: [
      { id: 'doc-files', label: 'ファイル管理', defaultOpen: true,
        pages: [
      ...
      { id: 'doc-tools', label: 'ツール',
        pages: [
          { id: 'doc-ocr',     label: 'OCR',         href: '/documents/ocr' },
          { id: 'doc-board',   label: '電子黒板',    href: '/documents/board' },
          { id: 'doc-deliver', label: '電子納品',    href: '/documents/deliver', badge: '2' },
          { id: 'doc-ver',     label: 'バージョン管理', href: '/documents/version' },
  ...
  {
    id: 'field-dx', icon: 'hard-hat', label: '現場DX',
    sections: [
      { id: 'field-proj', label: '工事管理', defaultOpen: true, roles: ['field', 'exec', 'safety'],
        pages: [
          ...
          { id: 'field-daily',    label: '作業日報',     href: '/field/daily',    badge: '5' },
        ]
      },
      { id: 'field-work', label: '現場作業', roles: ['field', 'safety'],
        pages: [
          { id: 'field-photo',    label: '現場写真',     href: '/field/photos' },
          { id: 'field-measure',  label: '出来形管理',   href: '/field/measure' },
          { id: 'field-safety',   label: '安全管理',     href: '/field/safety',   badge: '!' },
          { id: 'field-ky',       label: 'KY活動',       href: '/field/ky' },
        ]
      },
      { id: 'field-resource', label: 'リソース管理', roles: ['field'],
        pages: [
  ...
  {
    id: 'partner', icon: 'handshake', label: '協力会社連携',
    sections: [
      { id: 'partner-mgmt', label: '協力会社管理', roles: ['field', 'partner'],
        pages: [
          { id: 'partner-list',    label: '協力会社一覧', href: '/partner/list' },
          { id: 'partner-entry',   label: '入退場管理',   href: '/partner/entry' },
          { id: 'partner-docs',    label: '提出書類',     href: '/partner/docs',   badge: '4' },
          { id: 'partner-edu',     label: '安全教育',     href: '/partner/education' },
          { id: 'partner-contract',label: '契約管理',     href: '/partner/contract' },
          { id: 'partner-invoice', label: '請求管理',     href: '/partner/invoice' },
        ]
      },
    ]
  },
  {
    id: 'gis', icon: 'globe', label: 'GIS / 地図',
    sections: [
      { id: 'gis-map', label: '地図情報',
        pages: [
          ...
          { id: 'gis-realtime',label: 'リアルタイム位置', href: '/gis/realtime' },
        ]
      },
    ]
  },
  {
    id: 'ai', icon: 'brain', label: 'AI・分析基盤',
    sections: [
  ...
  {
    id: 'iot', icon: 'signal', label: 'IoT・リアルタイム監視',
    sections: [
      { id: 'iot-monitor', label: '監視',
        pages: [
          ...
          { id: 'iot-alerts',   label: 'アラート管理',   href: '/iot/alerts',   badge: '3' },
  ...
  {
    id: 'erp', icon: 'building-2', label: 'ERP・経営管理',
    sections: [
      { id: 'erp-finance', label: '財務管理', roles: ['exec'],
        pages: [
      ...
      { id: 'erp-ops', label: '業務管理', roles: ['exec'],
        pages: [
  ...
  {
    id: 'security', icon: 'shield', label: 'セキュリティ・監査',
    sections: [
      { id: 'sec-monitor', label: '監視', roles: ['admin'],
        pages: [
          ...
          { id: 'sec-incident', label: 'インシデント', href: '/security/incident' },
  ...
  {
    id: 'workflow', icon: 'git-branch', label: 'ワークフロー',
    sections: [
      { id: 'wf-process', label: '承認プロセス',
        pages: [
          { id: 'wf-approval', label: '承認一覧',   href: '/workflow/approval', badge: '5' },
  ...
  {
    id: 'robotics', icon: 'bot', label: '自動化・ロボティクス',
    sections: [
      { id: 'robo-ops', label: 'ロボティクス',
        pages: [
  ...
  {
    id: 'system', icon: 'settings', label: 'システム管理',
    sections: [
      { id: 'sys-ops', label: '運用', roles: ['admin'],
        pages: [
