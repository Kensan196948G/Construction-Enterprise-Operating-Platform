"""Alembic environment configuration for object-service."""
...
from object_app.storage.database import Base  # noqa: E402
import object_app.storage.orm_models  # noqa: E402, F401 — register models
