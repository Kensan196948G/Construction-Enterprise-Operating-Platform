...
export async function seedRichDemo(
  ...
  const isoRecords = [
    ...
    // ── ISO ダミーデータ拡充（v0.14.5: 各ドメインタブ10件）──
    {
      id: "d-iso-qp-2",
      kind: "quality-plan" as const,
      projectId: "d-project-tunnel",
      number: "DEMO-QP-2026-002",
      title: "トンネル改修 品質計画（デモ）",
      status: "published",
      payload: { planNo: "DEMO-QP-2026-002", target: "覆工・防水" },
    },
    {
      id: "d-iso-qp-3",
      kind: "quality-plan" as const,
      projectId: "d-project-road",
      number: "DEMO-QP-2026-003",
      title: "舗装工事 品質計画（デモ）",
      status: "under_review",
      payload: { planNo: "DEMO-QP-2026-003", target: "路盤・表層" },
    },
    {
      id: "d-iso-qp-4",
      kind: "quality-plan" as const,
      projectId: "d-project-bridge",
      number: "DEMO-QP-2026-004",
      title: "橋梁架替 品質計画（デモ）",
      status: "draft",
      payload: { planNo: "DEMO-QP-2026-004", target: "下部工・上部工" },
    },
    {
      id: "d-iso-qi-2",
      kind: "quality-inspection" as const,
      title: "コンクリート打設後検査（デモ）",
      status: "pass",
      payload: { inspectionType: "打設後検査", measured: "24.1 N/mm²" },
    },
    {
      id: "d-iso-qi-3",
      kind: "quality-inspection" as const,
      title: "鉄筋継手検査（デモ）",
      status: "pass",
      payload: { inspectionType: "継手検査", measured: "適" },
    },
    {
      id: "d-iso-nc-2",
      kind: "nonconformity" as const,
      ...
      title: "防水シート重ね幅不足（デモ）",
      status: "in_progress",
      payload: { description: "防水シートの重ね幅が基準未満", severity: "minor" },
    },
    {
      id: "d-iso-nc-3",
      kind: "nonconformity" as const,
      ...
      title: "舗装厚不足（デモ）",
      status: "open",
      payload: { description: "表層厚が設計値未満の区間あり", severity: "moderate" },
    },
    {
      id: "d-iso-env-2",
      kind: "environmental-aspect" as const,
      title: "重機の排ガス・騒音（デモ）",
      status: "moderate",
      payload: { aspectName: "排ガス・騒音", activity: "掘削・盛土" },
    },
    {
      id: "d-iso-env-3",
      kind: "environmental-aspect" as const,
      title: "濁水の発生（デモ）",
      status: "major",
      payload: { aspectName: "濁水", activity: "山留め掘削" },
    },
    {
      id: "d-iso-legal-2",
      kind: "legal-requirement" as const,
      title: "建設リサイクル法の適用確認（デモ）",
      status: "compliant",
      payload: { lawName: "建設リサイクル法", applicable: "分別解体" },
    },
    {
      id: "d-iso-legal-3",
      kind: "legal-requirement" as const,
      title: "振動規制法の適用確認（デモ）",
      status: "compliant",
      payload: { lawName: "振動規制法", applicable: "杭打工事" },
    },
    {
      id: "d-iso-legal-4",
      kind: "legal-requirement" as const,
      title: "労働安全衛生法の適用確認（デモ）",
      status: "partially_compliant",
      payload: { lawName: "労働安全衛生法", applicable: "墜落防止" },
    },
    {
      id: "d-iso-waste-2",
      kind: "waste-record" as const,
      projectId: "d-project-tunnel",
      title: "ずり（掘削土砂）の搬出記録（デモ）",
      status: "in_progress",
      payload: { wasteType: "掘削土砂", quantity: 45.2, unit: "t" },
    },
    {
      id: "d-iso-waste-3",
      kind: "waste-record" as const,
      projectId: "d-project-road",
      title: "アスファルト殻の搬出記録（デモ）",
      status: "closed",
      payload: { wasteType: "アスファルト殻", quantity: 18.0, unit: "t" },
    },
    {
      id: "d-iso-hazard-2",
      kind: "hazard" as const,
      ...
      payload: {
        workActivity: "掘削作業",
        hazardType: "接触",
        hazardDescription: "バックホウ旋回範囲への立入り",
      },
    },
    {
      id: "d-iso-nearmiss-2",
      ...
      title: "足場上でのつまずき（デモ）",
      status: "in_progress",
      payload: { description: "足場板上の資材でつまずいた" },
    },
    {
      id: "d-iso-safedu-2",
      kind: "safety-education" as const,
    ...
    },
    {
      ...
      title: "週間安全パトロール（デモ）",
      status: "closed",
      payload: { inspectionType: "週間パトロール", inspectedAt: "2026-08-11" },
    },
    {
      id: "d-iso-asset-2",
      kind: "asset" as const,
      title: "クローラクレーン（デモ）",
      status: "active",
      payload: { name: "クローラクレーン 50t", assetType: "建設機械" },
    },
    {
      id: "d-iso-asset-mp-2",
      kind: "asset-maintenance-plan" as const,
      title: "クレーン年次点検計画（デモ）",
      status: "active",
      payload: { maintenanceType: "年次点検" },
    },
    {
      id: "d-iso-asset-ins-2",
      kind: "asset-inspection" as const,
      title: "クレーン点検結果（デモ）",
      status: "pass",
      payload: { conductedAt: "2026-08-01" },
    },
    {
      id: "d-iso-asset-risk-2",
      kind: "asset-risk-assessment" as const,
      title: "クレーン老朽化リスク評価（デモ）",
      status: "medium",
      payload: { assessedAt: "2026-08-01", failureProbability: 2, consequenceSeverity: 5 },
    },
    {
      id: "d-iso-bim-eir-2",
      kind: "bim-eir" as const,
    ...
    },
    {
      id: "d-iso-bim-con-2",
      kind: "bim-container" as const,
      title: "共有エリア モデルコンテナ（デモ）",
      status: "shared",
      payload: { containerCode: "SHARED-001" },
    },
    {
      id: "d-iso-bim-coord-2",
      kind: "bim-coordination-issue" as const,
      title: "鉄筋と埋設管の干渉（デモ）",
      status: "open",
      payload: { issueType: "干渉" },
    },
    {
      id: "d-iso-bim-coord-3",
      kind: "bim-coordination-issue" as const,
      title: "梁と設備配管の納まり（デモ）",
      status: "in_progress",
      payload: { issueType: "納まり" },
    },
    {
      id: "d-iso-audit-plan-2",
      kind: "audit-plan" as const,
      title: "品質内部監査計画（デモ）",
      status: "completed",
      payload: { isoStandard: "ISO 9001", scheduledAt: "2026-07-20" },
    },
    {
      id: "d-iso-audit-plan-3",
      kind: "audit-plan" as const,
      title: "環境内部監査計画（デモ）",
      status: "in_progress",
      payload: { isoStandard: "ISO 14001", scheduledAt: "2026-08-25" },
    },
    {
      id: "d-iso-audit-find-2",
      kind: "audit-finding" as const,
      title: "文書管理の不備（デモ）",
      status: "in_progress",
      payload: { findingType: "軽微", description: "品質記録の保管場所不明確" },
    },
    {
      id: "d-iso-audit-find-3",
      kind: "audit-finding" as const,
      title: "教育訓練記録の未整備（デモ）",
      status: "open",
      payload: { findingType: "観察", description: "安全教育受講記録の一部欠落" },
    },
    {
      id: "d-iso-audit-find-4",
      kind: "audit-finding" as const,
      title: "設備点検記録の遅延（デモ）",
      status: "closed",
      payload: { findingType: "指摘", description: "点検記録の提出遅延" },
    },
    {
      id: "d-iso-ca-2",
      kind: "corrective-action" as const,
      title: "かぶり厚不足への是正（デモ）",
      status: "in_progress",
      payload: { sourceType: "不適合", description: "補修計画の策定と実施" },
    },
    {
      id: "d-iso-ca-3",
      kind: "corrective-action" as const,
      title: "防水シート重ね幅への是正（デモ）",
      status: "open",
      payload: { sourceType: "不適合", description: "重ね幅の再施工" },
    },
    {
      id: "d-iso-isms-asset-2",
      kind: "isms-asset" as const,
      title: "案件管理システム（デモ）",
      status: "in_progress",
      payload: { name: "案件DB", assetType: "ソフトウェア", classification: "社外秘" },
    },
    {
      id: "d-iso-isms-threat-2",
      kind: "isms-threat" as const,
      title: "マルウェア感染（デモ）",
      status: "open",
      payload: {
    ...
    {
      id: "d-iso-isms-threat-3",
      kind: "isms-threat" as const,
      title: "端末紛失（デモ）",
      status: "open",
      payload: { threatType: "紛失", description: "現場端末の紛失", likelihood: 0.5, impact: 0.5 },
    },
    {
      id: "d-iso-isms-risk-2",
      kind: "isms-risk-assessment" as const,
      title: "情報資産リスク評価（デモ）",
      status: "open",
      payload: { assessedAt: "2026-08-01", assessedBy: "ISMS管理者", overallRiskLevel: "中" },
    },
    {
      id: "d-iso-isms-risk-3",
      kind: "isms-risk-assessment" as const,
      title: "サプライチェーンリスク評価（デモ）",
      status: "in_progress",
      payload: { assessedAt: "2026-08-10", assessedBy: "ISMS管理者", overallRiskLevel: "低" },
    },
    {
      id: "d-iso-isms-inc-2",
      kind: "isms-incident" as const,
    ...
    },
    {
      ...
      title: "大地震シナリオ（デモ）",
      status: "open",
      payload: { scenarioType: "地震", probability: 0.1, impact: 0.9 },
    },
    {
      id: "d-iso-bcp-rs-3",
      kind: "bcp-risk-scenario" as const,
      title: "台風・水害シナリオ（デモ）",
      status: "open",
      payload: { scenarioType: "風水害", probability: 0.5, impact: 0.7 },
    },
    {
      id: "d-iso-bcp-drill-2",
      kind: "bcp-drill" as const,
      title: "地震対応訓練（デモ）",
      status: "closed",
      payload: { drillType: "地震対応訓練", conductedAt: "2026-07-10" },
    },
    {
      id: "d-iso-bcp-drill-3",
      kind: "bcp-drill" as const,
      title: "情報復旧訓練（デモ）",
      status: "closed",
      payload: { drillType: "情報復旧訓練", conductedAt: "2026-08-05" },
    },
    {
      id: "d-iso-bcp-rs-4",
      kind: "bcp-risk-scenario" as const,
      title: "感染症まん延シナリオ（デモ）",
      status: "closed",
      payload: { scenarioType: "感染症", probability: 0.5, impact: 0.5 },
    },
  ];
  ...
  const workOrderSeed: readonly WorkOrderSeedItem[] = [
    ...
    },
    {
      id: "d-work-order-6",
      projectId: "d-project-road",
      title: "路盤工（第 2 工区）転圧確認",
      description: "転圧回数と締固め度の確認（デモ）",
      status: "in_progress",
      dueDate: "2026-08-21",
      assigneeId: "user-op-a",
    },
    ...
    },
    {
      ...
      status: "completed",
      dueDate: "2026-08-16",
      completedAt: ts("2026-08-16T17:00:00.000Z"),
      assigneeId: "user-op-a",
    },
  ] as const;
  ...
  const inspectionSeed: readonly InspectionSeedItem[] = [
    ...
    },
    {
      ...
      inspectorId: "user-quality",
      checklistItems: [
        { label: "締固め度の基準適合", passed: true },
        { label: "高さ・幅の出来形", passed: true },
      ],
    },
    {
      id: "d-inspection-6",
      projectId: "d-project-road",
      title: "アスファルト舗装の仕上り検査",
      result: "pending",
      inspectorId: "user-quality",
      checklistItems: [],
    },
    {
      ...
      inspectorId: "user-quality",
      checklistItems: [
        { label: "トルク係数の管理", passed: true },
        { label: "軸力のばらつき", passed: false },
      ],
    },
    {
      id: "d-inspection-8",
      ...
      inspectorId: "user-quality",
      checklistItems: [
        { label: "鉄筋径・本数", passed: true },
        { label: "継手位置の規定", passed: true },
      ],
    },
    {
      id: "d-inspection-9",
  ...
  const supplierSeed: readonly SupplierSeedItem[] = [
    ...
    {
      id: "d-supplier-6",
      supplierName: "デモ建機リース",
      supplierCode: "SUP-0006",
      category: "建設機械",
      status: "approved",
      evaluationDate: "2026-07-20",
      nextEvaluationDate: "2027-07-19",
      score: 84,
      isoClause: "8.4 外部提供者",
    },
    {
      id: "d-supplier-7",
      supplierName: "デモコンクリート二次製品",
    ...
    {
      id: "d-supplier-8",
      supplierName: "デモ産業廃棄物処理",
      supplierCode: "SUP-0008",
      category: "廃棄物処理",
      status: "conditional",
      evaluationDate: "2026-06-25",
      nextEvaluationDate: "2026-12-24",
      score: 76,
      isoClause: "8.4 外部提供者",
      notes: "マニフェスト提出遅延 1 件（デモ）",
    },
    {
      id: "d-supplier-9",
      supplierName: "デモ鋼材商社",
      ...
      nextEvaluationDate: "2027-07-04",
      score: 90,
      isoClause: "8.4 外部提供者",
    },
    {
      id: "d-supplier-10",
      supplierName: "デモ電気工事協力会",
  ...
  const objectiveSeed: readonly ObjectiveSeedItem[] = [
    ...
    },
    {
      id: "d-objective-5",
      title: "工事写真の欠落ゼロ",
      description: "黒板・ステーションピン写り込みを全件確認（デモ）",
      isoClause: "6.2 品質目標",
      target: "欠落件数",
      unit: "件",
      baseline: 3,
  ...
  const riskSeed: readonly RiskSeedItem[] = [
    ...
    {
      id: "d-risk-6",
      title: "梅雨期の地盤緩みによる法面崩壊",
      description: "法面の安定管理リスク（デモ）",
      isoClause: "6.1 リスク及び機会",
      likelihood: 3,
      impact: 4,
      riskLevel: "high",
      status: "assessed",
      treatmentPlan: "排水工・法面計測の実施（デモ）",
      residualRisk: "中",
      ownerId: "user-sm-a",
    ...
    },
    {
      id: "d-risk-7",
      title: "猛暑による熱中症発生",
      description: "WBGT 値の高い日の作業員リスク（デモ）",
      isoClause: "6.1 リスク及び機会",
      likelihood: 4,
      impact: 3,
      riskLevel: "high",
      status: "mitigated",
      treatmentPlan: "WBGT 管理・休憩ルール適用（デモ）",
      residualRisk: "低",
      ownerId: "user-safety",
      reviewDate: "2026-08-31",
    },
    {
      id: "d-risk-8",
      title: "資材納入遅延による工程遅延",
      description: "サプライチェーン上の遅延リスク（デモ）",
      isoClause: "6.1 リスク及び機会",
      likelihood: 3,
      impact: 3,
      riskLevel: "medium",
      status: "identified",
      treatmentPlan: "納入スケジュールの週次確認（デモ）",
      ownerId: "user-procurement",
      reviewDate: "2026-10-31",
    },
    {
      id: "d-risk-9",
      title: "重機接触事故",
      description: "車両系建設機械の接触リスク（デモ）",
      isoClause: "6.1 リスク及び機会",
      likelihood: 2,
      impact: 5,
      riskLevel: "medium",
      status: "accepted",
      treatmentPlan: "誘導員配置・分離計画（デモ）",
      residualRisk: "低",
      ownerId: "user-safety",
      reviewDate: "2026-11-30",
    },
    {
      id: "d-risk-10",
      title: "検査記録の記載漏れ",
      description: "品質記録の不備リスク（デモ）",
      isoClause: "6.1 リスク及び機会",
      likelihood: 2,
      impact: 2,
      riskLevel: "very_low",
      status: "closed",
      treatmentPlan: "チェックリスト運用（デモ）",
      ownerId: "user-quality",
      reviewDate: "2026-07-31",
    },
  ] as const;
  ...
  const reviewSeed: readonly ReviewSeedItem[] = [
    ...
    },
    {
      ...
      agenda: "環境側面の評価・廃棄物削減施策（デモ）",
      outcomes: "廃棄物分別の強化を決定（デモ）",
      isoClause: "9.3 マネジメントレビュー",
      facilitatorId: "user-admin",
    },
    {
      ...
      agenda: "建設機械の維持管理・更新計画（デモ）",
      outcomes: "建機リース切替を承認（デモ）",
      isoClause: "9.3 マネジメントレビュー",
      facilitatorId: "user-admin",
    },
    {
      ...
      agenda: "ISMS リスク評価結果・インシデント報告（デモ）",
      isoClause: "9.3 マネジメントレビュー",
      facilitatorId: "user-admin",
    },
    {
      ...
      nextReviewDate: "2026-10-10",
      agenda: "BCP 訓練結果・改善事項（デモ）",
      outcomes: "訓練間隔を半年に短縮（デモ）",
      isoClause: "9.3 マネジメントレビュー",
      facilitatorId: "user-admin",
    },
    {
      ...
      agenda: "供給者評価結果・是正要求（デモ）",
      isoClause: "9.3 マネジメントレビュー",
      facilitatorId: "user-procurement",
    },
    {
      id: "d-review-9",
      title: "BIM/CIM 活用レビュー",
      status: "scheduled",
      reviewDate: "2026-09-05",
      nextReviewDate: "2026-12-05",
      agenda: "BIM/CIM データ品質・連携状況（デモ）",
      isoClause: "9.3 マネジメントレビュー",
      facilitatorId: "user-quality",
    },
    {
      id: "d-review-10",
      title: "年度総括マネジメントレビュー",
      status: "scheduled",
      reviewDate: "2026-12-10",
      nextReviewDate: "2027-03-10",
      agenda: "年間目標達成状況・次期方針（デモ）",
      isoClause: "9.3 マネジメントレビュー",
      facilitatorId: "user-admin",
    },
  ] as const;
  ...
  const aiBuildSeed: readonly AiBuildSeedItem[] = [
    ...
    },
    {
      id: "d-ai-build-5",
      projectId: "d-project-building",
      name: "seismic-retrofit-check",
      theme: "耐震改修工事の品質記録 DX",
      purpose: "改修工事の検査記録自動化 PoC（デモ）",
      scope: "梁補強・検査記録",
      targetUsers: "品質管理担当",
      templateVersion: "1.2.0",
      status: "generated",
      placeholderChecked: true,
      generatedAt: ts("2026-08-13T10:00:00.000Z"),
    },
    {
      id: "d-ai-build-6",
      name: "drainage-inspection-app",
      theme: "排水設備の点検記録 DX",
      purpose: "点検結果のデジタル化検証（デモ）",
      scope: "排水設備の定期点検",
      targetUsers: "設備点検員",
      templateVersion: "1.0.0",
      status: "archived",
      placeholderChecked: true,
      generatedAt: ts("2026-07-25T09:00:00.000Z"),
    },
    {
      id: "d-ai-build-7",
      name: "asphalt-temp-logger",
      theme: "舗装温度管理の自動記録",
      purpose: "施工温度の自動記録 PoC（デモ）",
      scope: "舗装温度の連続測定",
      targetUsers: "現場監督",
      templateVersion: "1.1.0",
      status: "generated",
      placeholderChecked: false,
      generatedAt: ts("2026-08-14T14:00:00.000Z"),
    },
    {
      id: "d-ai-build-8",
      name: "concrete-curing-monitor",
      theme: "コンクリート養生温度の監視",
      purpose: "養生温度の遠隔監視検証（デモ）",
      scope: "養生温度・強度推定",
      targetUsers: "品質管理担当",
      templateVersion: "0.8.0",
      status: "generated",
      placeholderChecked: true,
      generatedAt: ts("2026-08-15T08:30:00.000Z"),
    },
    {
      id: "d-ai-build-9",
      name: "traffic-control-board",
      theme: "交通規制の管理 DX",
      purpose: "規制計画の共有基盤（デモ）",
      scope: "規制図・時間帯の管理",
      targetUsers: "交通誘導員",
      templateVersion: "1.0.0",
      status: "archived",
      placeholderChecked: false,
      generatedAt: ts("2026-06-30T09:00:00.000Z"),
    },
    {
      id: "d-ai-build-10",
      name: "slope-instrumentation",
      theme: "法面計測データの可視化",
      purpose: "計測値の自動集計 PoC（デモ）",
      scope: "法面変位・雨量計測",
      targetUsers: "技術本部",
      templateVersion: "0.9.1",
      status: "generated",
      placeholderChecked: true,
      generatedAt: ts("2026-08-16T11:00:00.000Z"),
    },
  ] as const;
  ...
  const dxProjectSeed: readonly DxProjectSeedItem[] = [
    ...
    {
      id: "d-dx-7",
      slug: "civil-weather-wbgt",
      nameJa: "気象・WBGT 判定基盤",
      nameEn: "Civil Weather Water Decision",
      shortName: "気象 WBGT",
      summary: "熱中症リスク判定と工事気象判断（デモ）",
      portfolioType: "internal",
      companyAssetUse: "yes",
      domainCode: "safety",
      lifecycleState: "production",
      ...
      ownerTeam: "安全環境本部",
      approvedProgress: 82,
      progressMilestone: "本番運用中",
      nextReviewAt: "2026-10-15",
    },
    {
      id: "d-dx-8",
      slug: "terrain-slope-risk",
      nameJa: "地形・斜面リスクビューア",
      nameEn: "Civil Terrain Slope Risk Viewer",
      shortName: "斜面リスク",
      summary: "地形データと斜面リスクの可視化（デモ）",
      portfolioType: "internal",
      companyAssetUse: "review",
      domainCode: "gis",
      lifecycleState: "verification",
      ...
      ownerTeam: "技術本部",
      approvedProgress: 60,
      progressMilestone: "検証中",
      nextReviewAt: "2026-09-20",
    },
    {
      id: "d-dx-9",
      slug: "material-photo-sync",
      nameJa: "材料写真クラウド同期",
      nameEn: "Material Photo Cloud Sync",
      shortName: "フォト同期",
      summary: "現場写真ログのクラウド同期（デモ）",
      portfolioType: "internal",
      companyAssetUse: "yes",
      domainCode: "field",
      ...
      ownerTeam: "現場 DX 室",
      approvedProgress: 45,
      progressMilestone: "Phase2 開発中",
      nextReviewAt: "2026-12-31",
    },
    {
      id: "d-dx-10",
      slug: "open-data-intelligence",
      nameJa: "土木オープンデータ基盤",
      nameEn: "Civil Open Data Intelligence",
      shortName: "オープンデータ",
      summary: "公開データの統合・分析基盤（デモ）",
      portfolioType: "common",
      companyAssetUse: "review",
      domainCode: "data",
      lifecycleState: "production_ready",
  ...
  const photoLogSeed: readonly PhotoLogSeedItem[] = [
    ...
    },
    {
      ...
      transactionType: "received",
      inspectionStatus: "passed",
      capturedAt: ts("2026-08-10T09:10:00.000Z"),
      objectKey: "photos/demo-photo-7.jpg",
    },
    {
      id: "d-photo-log-8",
      projectCode: "DEMO-2026-005",
      materialName: "あと施工アンカー",
      materialCategory: "金物",
      quantity: 200,
      unit: "本",
      storagePlace: "G 倉庫",
      memo: "ロット A-2026-0808（デモ）",
      transactionType: "received",
      inspectionStatus: "pending",
      needsReview: true,
      capturedAt: ts("2026-08-12T14:20:00.000Z"),
      objectKey: "photos/demo-photo-8.jpg",
    },
    {
      id: "d-photo-log-9",
      projectCode: "DEMO-2026-003",
      materialName: "路盤材（再生クラッシャラン）",
      materialCategory: "骨材",
      quantity: 30,
      unit: "t",
      storagePlace: "H ヤード",
      ...
      transactionType: "placed",
      inspectionStatus: "passed",
      capturedAt: ts("2026-08-08T10:00:00.000Z"),
      objectKey: "photos/demo-photo-9.jpg",
    },
    {
      id: "d-photo-log-10",
      projectCode: "DEMO-2026-001",
      ...
      transactionType: "returned",
      inspectionStatus: "passed",
      capturedAt: ts("2026-08-15T16:40:00.000Z"),
      objectKey: "photos/demo-photo-10.jpg",
    },
  ] as const;
