...
| 4 | 中核のビルド・主要テスト・E2E・CI・データ移行検証が成功 | ⚠️ | ローカル build ✅・テスト 398/398 ✅・parity 27/27 ✅・PR #40 CI 全成功 ✅・一時 SQLite への実 import（3 件）✅。ブラウザ E2E と本番 DB への実 import は未実施 |
...
3. ブラウザ E2E（Playwright）を追加し、`/iso-app` の主要 CRUD・状態遷移を自動検証する。
